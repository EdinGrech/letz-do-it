                ...
                foreach ($groups_owner as $group) {
                    if ($group['id'] != $groups_owner[0]['id']) {
                        ...
                        echo '<table class="table table-striped table-dark style="min-width: 34%;">
                            <thead>
                            <tr>
                            <th style="background: #b38d10;" scope="col"> <div style="display:flex; justify-content: space-between;"> <div style="padding-top:10px;"> <div> Tasks' . " for group " . $group['id'] . '</div></div><a href="add-task.php?group_id=' . $group['id'] . '"
